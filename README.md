...
![Status](./profile-3d-contrib/profile-orange.svg)


> 🟠 Se o arquivo `profile-orange.svg` ainda não existir, você pode criar um novo tema baseado no SVG existente e editar suas cores ou usar `profile-night-rainbow.svg` como base temporária.
...
- 🔥 [**alura-imersao**](https://github.com/RaFeltrim/alura-imersao)  
  Aplicação **back-end** desenvolvida em **Java**, com consumo de **APIs**, manipulação de **JSON**, tratamento de exceções e customização CLI.

- 🔥 [**AutoCourseDownloader**](https://github.com/Ra
<h1 align="center">
  <span style="color:#FFA500;">Olá, eu sou Rafael Feltrim!</span>
</h1>
